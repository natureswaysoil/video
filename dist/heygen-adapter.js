...
function buildVisualPrompt(row, title, details, visualHint) {
    ...
    return cleanForPrompt(`Create a conversion-focused vertical product ad for Nature's Way Soil. Product: ${title}. Details: ${details}. ` +
...
async function createSheetsAuthClient() {
    return (0, google_auth_1.createGoogleAuthClient)(['https://www.googleapis.com/auth/spreadsheets']);
}
...
exports.default = { mapProductToHeyGenPayload, writeBackMappingsToSheet };
